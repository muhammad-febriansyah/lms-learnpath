...
const STATUS_TONES: Record<string, string> = {
    ...
    locked: 'border-transparent bg-amber-100 text-amber-700 ',
    passed: 'border-transparent bg-emerald-100 text-emerald-700 ',
    ...
    issued: 'border-transparent bg-emerald-100 text-emerald-700 ',
    met: 'border-transparent bg-emerald-100 text-emerald-700 ',
    gap: 'border-transparent bg-amber-100 text-amber-700 ',
    exceeded: 'border-transparent bg-sky-100 text-sky-700 ',
