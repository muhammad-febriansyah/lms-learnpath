...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
    return (
        <motion.div
            ...
            className={cn(
                'relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between gap-3 self-start rounded-full bg-transparent px-4 py-2 xl:flex dark:bg-transparent',
...
export const NavbarLogo = ({
    ...
    return (
        <a
            href={href}
            className="relative z-20 mr-2 flex shrink-0 items-center space-x-2 px-2 py-1 text-sm font-normal text-black"
        >
            {children}
        </a>
    );
